                ...
                <div class="card shadow mb-4">
                    <div class="container mt-5">
                        <form enctype="multipart/form-data" method="post" id="add_create" name="add_create"
                            ...
                            <input type="hidden" name="content_background_image" value="<?= trim($content_obj['background_image']) ? trim($content_obj['background_image']) : '' ?>" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <?php } ?><input type="file"  name="background_image" class="form-control">
                            </div>
                            <div class="form-group">
